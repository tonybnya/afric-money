    ...
    <div class="dashboard-page">
      <div class="container">
        ...
        <h1 class="welcome-heading">
          Welcome Dear <span class="accent">RandomName !</span>
        </h1>
        ...
        <div class="top-row">
          ...
          <div class="account-card account-card--active" role="region" aria-label="Compte actif">
            ...
            <div class="card-balance">
              ...
              <span class="balance-amount">
                @if (balanceVisible()) { 5 000 000 } @else { *** }
              </span>
              <span class="balance-currency">XAF</span>
            </div>
            <p class="card-account-number">+237 690 20 20 20</p>
          </div>
          ...
          <div class="quick-actions" role="group" aria-label="Actions rapides">
            <button type="button" class="quick-action" id="btn-send" (click)="showSend.set(true)">
            ...
            <button type="button" class="quick-action" id="btn-add" (click)="showAdd.set(true)">
              <div class="quick-action-icon">
        ...
        <div class="modal-overlay" role="dialog" aria-modal="true" aria-labelledby="add-title"
          ...
          <div class="modal-box" (click)="$event.stopPropagation()">
            ...
            <div class="form-group">
              ...
              <input id="add-amount" type="number" min="1" class="form-input" placeholder="" />
            </div>
            <div class="modal-actions">
              <button type="button" class="btn-ghost" (click)="showAdd.set(false)">Retour</button>
              <button type="button" class="btn-primary" id="btn-add-submit">Valider</button>
            </div>
          </div>
        </div>
      }
        ...
        <div class="modal-overlay" role="dialog" aria-modal="true" aria-labelledby="send-title"
          ...
          <div class="modal-box" (click)="$event.stopPropagation()">
            ...
            <div class="form-group">
              ...
              <input id="send-amount" type="number" min="1" class="form-input" placeholder="" />
            </div>
            <div class="modal-actions">
              <button type="button" class="btn-ghost" (click)="showSend.set(false)">Retour</button>
              <button type="button" class="btn-primary" id="btn-send-submit">Valider</button>
            </div>
          </div>
        </div>
      }
